...
<section class="content" id="englishcontroller" ng-app="pokemon" ng-controller="english">

    <!-- Form  -->
    <div class="modal fade" id="english_form" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lgx" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="largeModalLabel">English</h4>
                    <div class="header-dropdown m-r--5 " loading="english">
                        Cargando datos...
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header bg-lime"
                        ...
                        <div class="header-dropdown m-r--5 " loading="english" style="display: none">
                            Cargando datos...
                            <div class="preloader pl-size-x2">
                                <div class="spinner-layer">
                                    <div class="circle-clipper left">
...
<script src="js/controller/english.js"></script>
</body>
